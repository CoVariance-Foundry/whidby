...
def _build_rows(seed_rows: list[dict[str, Any]], acs_by_cbsa: dict[str, dict[str, Any]]) -> list[dict[str, Any]]:
    return [
        build_metro_payload(seed, acs_by_cbsa.get(str(seed["cbsa_code"])))
