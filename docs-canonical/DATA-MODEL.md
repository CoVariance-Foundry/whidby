...
- `docs/algo_spec_v2.md` is the scoring-methodology and support-debugging source of truth for how `seo_benchmarks` influence actual scores. It distinguishes report headline scores, raw V2 benchmark vectors, and Explore/strategy projections so support can explain disputed product scores without conflating raw measurements with presentation scores.
...
| 1.7.7   | 2026-06-02 | Scoring methodology support docs | Linked benchmark-driven scoring methodology and support-debugging contract for score explanations |
