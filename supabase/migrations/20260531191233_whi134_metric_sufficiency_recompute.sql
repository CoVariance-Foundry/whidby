...
--
-- WHI-134: make benchmark recompute produce run lineage and metric-family
-- sufficiency rows for the scoring strategy gates.
...
BEGIN
    ...
    VALUES (
        ...
        jsonb_build_object('seo_facts', true, 'census_cbp_establishments', true),
...
ALTER FUNCTION public.recompute_seo_benchmarks_without_lineage(INTEGER)
    SET search_path = public, pg_temp;
