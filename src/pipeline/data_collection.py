...
from .types import CollectionProfile, RawCollectionResult, build_collection_request
...
async def collect_data(
    ...
    *,
    ...
    logger.info(
        "M5 collect_data DONE api_calls=%d failures=%d failure_types=%s elapsed_ms=%d",
