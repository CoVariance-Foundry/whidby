      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            <a href="#" className="text-sm text-neutral-400 hover:text-dark transition-colors">Privacy</a>
            <a href="#" className="text-sm text-neutral-400 hover:text-dark transition-colors">Terms</a>
            <a href="#" className="text-sm text-neutral-400 hover:text-dark transition-colors">Contact</a>
          </div>
