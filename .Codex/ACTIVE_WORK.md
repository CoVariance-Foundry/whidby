...
- Continue research Phase 4 by converting the Phase 1-3 findings into a gap analysis against the current schema/data-collection approach: canonical demand source, metric-level sufficiency schema, local-place lineage, raw evidence retention, agent tool parity, pooling policy, and paid acquisition guardrails.
